...
#if defined(ANDROID)
#define ALOGE(...) __android_log_print(ANDROID_LOG_ERROR, "larkxr_openxr_pico_app", __VA_ARGS__)
#define ALOGV(...) __android_log_print(ANDROID_LOG_VERBOSE, "larkxr_openxr_pico_app", __VA_ARGS__)
#endif
