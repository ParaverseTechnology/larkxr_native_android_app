...
namespace lark
{
    ...
    class LARK_COMMON_API HttpClient {
    public:
        /**
         * 获取签名
        ...
        // 发送 GET 请求的同步方法，支持自定义请求头
        // @param url 目标 URL 地址
        // @param headers 请求头，以键值对的形式存储
        // @param on_response 响应处理函数
        int Get(const char* url, const std::map<std::string, std::string>& headers, OnResponse on_response);
        ...
        // 发送 GET 请求的异步方法，支持自定义请求头
        // @param url 目标 URL 地址
        // @param headers 请求头，以键值对的形式存储
        // @param on_response 响应处理函数
        int GetAsync(const char* url, const std::map<std::string, std::string>& headers, OnResponse on_response);
        ...
        // 发送 POST 请求的同步方法，支持自定义请求头
        // @param url 目标 URL 地址
        // @param body 请求体内容
        // @param content_type 请求体的内容类型
        // @param headers 请求头，以键值对的形式存储
        // @param on_response 响应处理函数
        int Post(const char* url, const char* body, const char* content_type, const std::map<std::string, std::string>& headers, OnResponse on_response);
        ...
        // 发送 POST 请求的异步方法，支持自定义请求头
        // @param url 目标 URL 地址
        // @param body 请求体内容
        // @param content_type 请求体的内容类型
        // @param headers 请求头，以键值对的形式存储
        // @param on_response 响应处理函数
        int PostAsync(const char* url, const char* body, const char* content_type, const std::map<std::string, std::string>& headers, OnResponse on_response);
    private:
        class Impl;
        Impl* impl_;
    };
